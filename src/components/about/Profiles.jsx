      ...
      <div className="flex md:flex-nowrap flex-wrap justify-center items-center xl:gap-24 lg:gap-16 gap-10 max-w-5xl mx-auto w-full">
        ...
        <div className="flex flex-col gap-8">
          <div className="flex flex-col gap-3 max-md:items-center">
            <h6 data-aos="fade-in" className="text-twitter">About</h6>
            <h2 data-aos="fade-in" className="xl:text-5xl lg:text-4xl sm:text-3xl text-2xl ">Stephane HERSEN</h2>
            <p data-aos="fade-in" className="text-gray-400">
              Designation:
              <span className="text-twitter">CEO</span>
            </p>
          </div>
          <div data-aos="fade-in" className="backdrop-blur-lg bg-gradient-to-r from-white/10 px-8 py-10 max-w-lg rounded-2xl lg:text-base text-sm">
            Seasoned CEO with Start -up Executive Job with tech companies
            as Head of Sales APAC for Airbus Singapore CTO.
          </div>
          <div data-aos="fade-in" className="flex gap-4 max-md:justify-center">
