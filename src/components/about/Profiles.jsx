        ...
        <div className="flex">
          ...
          >
            <CustomIMG
              src={CeoIMG}
              alt="CeoIMG"
              className="rounded-[250px] lg:w-96 w-72"
            />
          </div>
        </div>
        <div className="flex flex-col gap-8">
          <div className="flex flex-col gap-3 max-md:items-center">
            <h6 data-aos="fade-in" className="text-twitter">
              About
            </h6>
            <h2
              data-aos="fade-in"
          ...
          >
            Seasoned CEO with Start -up Executive Job with tech companies as
            Head of Sales APAC for Airbus Singapore CTO.
          </div>
