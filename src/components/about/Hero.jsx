    ...
    <section className="section-container pb-0 pt-20">
      <div className=" w-full grid xl:grid-cols-10 sm:grid-cols-10 sm:gap-0 gap-10 border-b-2 lg:pb-24 sm:pb-16 pb-10">
        <div className="sm:col-span-5 overflow-hidden">
          <h1 data-aos="fade-in" className="xl:text-5xl lg:text-4xl sm:text-3xl text-2xl font-bold xl:mb-24 lg:mb-16 mg:mb-12 mb-10">
          ...
          <CustomIMG data-aos="fade-in" src={Machine} alt="Cabine" className="sm:h-auto h-[350px] rounded-3xl overflow-hidden" />
        </div>
        <div className="sm:col-span-4 sm:col-start-7 sm:col-end-13 overflow-hidden">
          <CustomIMG data-aos="fade-in" src={Chair} alt="Cabine" className="sm:h-auto h-[350px] rounded-3xl overflow-hidden" />
