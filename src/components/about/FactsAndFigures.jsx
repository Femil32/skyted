    ...
    <section className="section-container">
      <div>
        ...
        <div className="flex md:flex-nowrap flex-wrap xl:gap-16 lg:gap-12 gap-10">
          <div data-aos="fade-in" className="md:flex-1 lg:p-10 p-5 xl:text-xl lg:text-lg md:text-base text-sm rounded-2xl bg-gradient-radial from-white to-cyan-100">
          ...
          <div data-aos="fade-in" className="md:flex-1 w-full lg:p-10 p-5 xl:text-xl lg:text-lg md:text-base text-sm rounded-2xl bg-gradient-radial from-white to-blue-100">
            <p className="max-w-sm tracking-wide md:leading-[35px] leading-[28px]">
