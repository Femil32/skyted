    ...
    <section className="section-container bg-white text-black">
      ...
      >
        ...
        <div className="mx-auto">
          ...
          <CtaBtn type="submit" value="Subscribe" name="subscribe" id="mc-embedded-subscribe" data-aos="fade-in" text="Submit" className="inline-block mx-auto bg-dark-blue text-white" />
        </div>
      </form>
    </section>
  );
