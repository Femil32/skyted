      ...
      <div className="flex flex-col md:flex-row justify-center items-center">
        <div className="md:w-3/5 order-2 md:order-1">
          <div className="mb-3 max-w-xl">
            <h6 className="text-xl font-medium text-dark-blue" data-aos="fade-in">Discover Key Factors</h6>
            <p className="py-4 text-base md:text-lg font-light tracking-wide" data-aos="fade-in">
          ...
          <div>
            <h6 className="text-xl font-medium text-dark-blue" data-aos="fade-in">This gives the product exclusive advantages:</h6>
            <ul className="space-y-2 list-disc p-4 text-base md:text-lg font-light tracking-wide" data-aos="fade-in">
