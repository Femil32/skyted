        ...
        <div className="md:w-3/5 order-2 md:order-1">
          <div data-aos="fade-in" className="mb-3 max-w-xl">
            <h6 className="text-xl font-medium text-dark-blue">
              Discover Key Factors
            </h6>
            <p className="py-4 text-base md:text-lg text-white  tracking-wide">
              In collaboration with the French regulatory agency DARPA, Skyted
              has embedded small resonators within their masks, deploying
              technology crafted to silence jet engines. These resonators are 10
              times more powerful than existing masks in the market.
            </p>
          </div>
