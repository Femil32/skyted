          ...
          >
            <div>
              <Input
                ...
                placeholder="Name"
                title="name"
                className="w-full rounded-xl backdrop-blur-lg bg-white/20 lg:placeholder:text-base placeholder:text-sm"
              />
            </div>
            <div>
              <Input
            ...
            <div>
              <TextArea
                ...
                placeholder="Message"
                name="message"
                className="w-full rounded-xl backdrop-blur-lg bg-white/20 lg:placeholder:text-base placeholder:text-sm resize-none"
                rows={5}
              />
            </div>
            ...
            <div className="md:space-y-8 space-y-5">
              ...
              >
                ...
                <address className="text-sm lg:text-base">
                  B612 – Toulouse Aerospace Innovation <br /> ParkToulouse,
                  France
                </address>
              </div>
              <div
