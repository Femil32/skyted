        ...
        <main className="mt-24">
          <div className="flex flex-col justify-center items-center">
            <div className="text-center mb-10">
              <span className="inline-block mb-4 text-gray-500" >Published January 13,2023 </span>
              <h2 className="lg:text-6xl md:text-4xl text-2xl font-medium" >Gamer Line – Silent Mask Headset</h2>
            </div>
            <CustomIMG src={BlogIMG} alt="BlogIMG" className="rounded-3xl overflow-hidden w-full max-h-[750px]" ImgClassName="max-h-[750px] w-full" />
            <div className="flex flex-col gap-4 mt-8 xl:px-32 md:text-lg" >
              ...
              <p className="text-gray-500">
                Post Covid, 2 billion hybrid workers need to handle Pre Covid travel habits and 6 to 10 calls a day.
                This implies a huge amount of stress for 56% of the workers who have been offered a remote job and must
                adapt to calls & video calls
